      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className='fixed bottom-24 right-6 z-50 w-80 sm:w-96 h-[450px] max-h-[70vh] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200'
          >
            {/* Header */}
